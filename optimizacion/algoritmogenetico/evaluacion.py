...
if __name__ == '__main__':
	...
	credentials = pika.PlainCredentials('server', 'emmanuel')
	connection = pika.BlockingConnection(pika.ConnectionParameters( host='192.168.1.162', credentials=credentials, heartbeat_interval=6000, blocked_connection_timeout=65535))
	channel = connection.channel()
